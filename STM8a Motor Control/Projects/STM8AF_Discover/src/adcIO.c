...
/* Private variables ---------------------------------------------------------*/
uint16_t Conversion_Value_IO = 0;
...
void ADCIO_Config(void)
{
  ...
  ADC2_DeInit();
	...
	/* Check Channel to Params 
	ADC2_CHANNEL_IO = ADC2_CHANNEL_0
	ADC2_SCHMITTTRIG_CHANNEL_IO = ADC2_SCHMITTTRIG_CHANNEL0*/

  /* Init ADC2 peripheral */
  ADC2_Init(ADC2_CONVERSIONMODE_SINGLE, ADC2_CHANNEL_0, ADC2_PRESSEL_FCPU_D2, \
            ADC2_EXTTRIG_TIM, DISABLE, ADC2_ALIGN_RIGHT, ADC2_SCHMITTTRIG_CHANNEL0,\
            DISABLE);
...
/**
  ...
  */
uint16_t GetADCIOData(void)
{
	return (Conversion_Value_IO);
}
