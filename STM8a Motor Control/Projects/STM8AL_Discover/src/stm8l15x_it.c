/**
  ...
  * @version VX.Y.ZRCx
  * @date    DD-Month-YYYY
  * @brief   ain Interrupt Service Routines.
...
INTERRUPT_HANDLER(TIM4_UPD_OVF_TRG_IRQHandler, 25)
{
  ...
  */
  ...
  /* Cleat Interrupt Pending bit */
	TIM4_ClearITPendingBit(TIM4_EventSource_Update);
...
INTERRUPT_HANDLER(USART1_RX_TIM5_CC_IRQHandler, 28)
{
  ...
  */
	...
	USART1_SR_Buf = USART1->SR;
	USART1Data=USART1->DR;
	
	if (((USART1_SR_Buf & USART_FLAG_FE)==USART_FLAG_FE)&(USART1Data==0))
	{
		BreakReceived=1;
	}
	...
	{		
		/* Framing error ? */
		if (USART1_SR_Buf & USART_FLAG_FE)
		{
			DataReceived=1;
			ReceptionError=1;					
		}
		...
		/* Overrun error ? */
		if (USART1_SR_Buf & USART_FLAG_OR)
		{
			DataReceived=1;
			ReceptionError=1;
		}
		...
		/* Data received ? */
		if (USART1_SR_Buf & USART_FLAG_RXNE)
		{
			DataReceived=1;
		}
	}	
