  ...
  72                     ; 59 		ADC2_Init(ADC2_CONVERSIONMODE_SINGLE, ADC2_CHANNEL_8, ADC2_PRESSEL_FCPU_D2, \
  72                     ; 60             ADC2_EXTTRIG_TIM, DISABLE, ADC2_ALIGN_RIGHT, ADC2_SCHMITTTRIG_CHANNEL8,\
  72                     ; 61             DISABLE);
  74  000e 4b00          	push	#0
  75  0010 4b08          	push	#8
  76  0012 4b08          	push	#8
  ...
  84                     ; 67 }
  87  0022 81            	ret	
 111                     ; 78 uint16_t GetADCData(void)
 111                     ; 79 {
 112                     	switch	.text
 113  0023               _GetADCData:
 117                     ; 80 	return (Conversion_Value);
